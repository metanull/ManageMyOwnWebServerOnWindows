Describe "Test-MessageQueue" -Tag "Functional","BeforeBuild" {
    ...
    Context "When the function is called" {
        ...
        It "Should not throw an exception when MessageQueueId is not found" {
            {Invoke-ModuleFunctionStub -MessageQueueId (New-Guid)} | Should -Not -Throw
        }
        It "Should return false when MessageQueueId is not found" {
            $Result = Invoke-ModuleFunctionStub -MessageQueueId (New-Guid)
            $Result | Should -BeFalse
        }
        It "Should return true when MessageQueueId is found" {
